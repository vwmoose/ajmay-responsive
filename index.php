...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>AJM Engineering Ltd</title>
        <meta name="description" content="Precision Engineers based in Wiltshire supplying a variety of industries with hard to make parts in exotic materials.">
        <meta name="keywords" content="Precision Engineers, Engineers Wiltshire, Engineers Corsham, Corsham, Wiltshire, Precision Engineers Wiltshire, Precision, Engineering, Mould Tools, Cavity Moulds, Injection Moulding">
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scales=1, user-scalable=no">
    ...
    <body data-spy="scroll" data-target=".navbar">
   		<span id="home_top" class="anchor"></span>
        <div class="navbar">
            <div class="navbar-inner">
				<img src="/img/ajm_logo_black.png" data-svg-fallback="/img/ajm_logo_black_sml.png" alt="AJM" />
                <div class="pull-right contact-details">
                	<span><img src="img/icon_phone.svg" alt="contact us" />&nbsp;<a href="tel:+4401249712620">+44 (0)1249 712620</a></span>&nbsp;&nbsp;&nbsp;&nbsp;<span><img src="img/icon_email.svg" alt="contact us" />&nbsp;<a href="mailto:sales@ajmay.uk">sales@ajmay.uk</a></span>
                </div>
                <div class="pull-right" style="clear: right;">
                    <ul class="nav">
                        <li><a class="navi" href="#home_top">Home</a></li>
		...
		<section id="home_page">
			<!-- carousel -->
			<div id="myCarousel" class="carousel slide" style="margin-bottom: 30px; background: url('../img/slide-01.png') center center repeat-x;">
				<div class="carousel-inner" >
					<div class="item active">
						<div class="container">
							<div class="carousel-caption">
								<h1>AJM Engineering Ltd</h1>
								<p class="lead" style="margin-bottom: 15px;">Celebrating more than 50 years of manufacturing quality precision engineered parts, moulds and tools to a variety of market sectors.</p>
								<div style="_margin-top: -30px;">
									<div class="slider-segment">
										<img class="slider-image slider-img-sml" src="/img/slider/s_oil_and_gas.png" alt="Oil & Gas" /><br/>
										<span class="segment-text">Oil & Gas</span>
									</div>
									<div class="slider-segment">
										<img style="_margin-top: 40px;" class="slider-image slider-img-sml" src="/img/slider/s_aviation.png" alt="Aviation" /><br/>
										<span class="segment-text">Aviation</span>
									</div>
									<div class="slider-segment">
										<img style="_margin-top: 80px;" class="slider-image slider-img-sml" src="/img/slider/s_nuclear.png" alt="Nuclear" /><br/>
										<span class="segment-text">Nuclear</span>
									</div>
									<div class="slider-segment">
										<img style="_margin-top: 80px;" class="slider-image slider-img-sml" src="/img/slider/s_military.png" alt="Military" /><br/>
										<span class="segment-text">Military</span>
									</div>
									<div class="slider-segment">
										<img style="_margin-top: 40px;" class="slider-image slider-img-sml" src="/img/slider/s_automotive.png" alt="Automotive" /><br/>
										<span class="segment-text">Automotive</span>
									</div>
									<div class="slider-segment">
										<img class="slider-image slider-img-sml" src="/img/slider/s_dairy.png" alt="Dairy" /><br/>
										<span class="segment-text">Dairy</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="item">
						<div class="container">
							<div class="carousel-caption">
								...
								<p class="lead" style="margin-bottom: 15px;">Our team of highly skilled precision engineers manufacture complex
									parts to extremely high tolerances specialising in hard to machine
									exotic materials</p>
									<img class="slider-image" src="/img/slider/s_cnc_turning.png" alt="CNC Turning" />
									<img class="slider-image" src="/img/slider/s_cnc_milling.png" alt="CNC Machining" />
									<img class="slider-image" src="/img/slider/s_cnc_multicav.png" alt="CNC Machining Multicav" />
							</div>
						</div>
					</div>
					<div class="item">
						<div class="container">
							<div class="carousel-caption">
								...
								<p class="lead" style="margin-bottom: 15px;">The manufacture of mould tools, jigs and fixtures is second 
									...
									<img class="slider-image" src="/img/slider/s_exeron_mould.png" alt="Mould and Tools" />
							</div>
						</div>
					</div>
					<div class="item">
						<div class="container">
							<div class="carousel-caption">
								...
								<p class="lead" style="margin-bottom: 15px;">Maximising customer value while minimising waste through continued investment in our people, machinery and emerging software technologies</p>
								<img class="slider-image" src="/img/slider/s_invest_apprentices.png" alt="People" />
								<img class="slider-image" src="/img/slider/s_invest_technology.png" alt="Technology" />
								<img class="slider-image" src="/img/slider/s_exeron_hsc_600.png" alt="Machinery" />
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="container">
            	<div class="row-fluid">
            		<div class="span12 text-center">
						<h1 class="ajmStrapLine" data-title='"Creating confidence Delivering quality"'><span>"Creating confidence Delivering quality"</span></h1>
            		</div>
            	</div>
				<div class="row-fluid">
					<div class="span4">
						<h3>Customer Focused</h3>
						<p>Having already achieved Lloyds LRQA certification we continue to transform our own systems and processes by working towards AS9100, OHAS18001, ISO27001, BS11000, ISO14001, ISO 22301 and Nuclear certifications, enabling us to provide a better service to our customers.</p>
						<p><a href="#quality" class="scrollto btn">View details »</a></p>
					</div>
					<div class="span4">
						<h3>Our Services</h3>
						<p>Up to 5 axis CNC Turning, Mill/Turn and Milling machines capable of working to micron tolerances in a variety of specialist materials.  In addition, we have EDM (Sparking and Wiring), Graphite Milling, QA and finishing equipment.</p><br/>
						<p><a href="#capabilities" class="scrollto btn">View details »</a></p>
					</div>
					<div class="span4">
        ...
        <div class="container txtblock nrthree">
        	<div class="container-inner">
				...
				<p class="text-center lead">AJM delivers customer requirements to the highest quality, on-time and at acceptable cost.</p>
			</div>
        </div>
		...
		<section id="works">
            ...
            <div id="works_items">
                <ul id="og-grid" class="og-grid">
                	<?php
                		//define variables
                		$strTitle_1 = "Precision Engineering";
                		$strBlock_1 = "All of our management and production staff are experienced engineers and we strive to push the boundaries of what is technically possible.  Our reputation is built under-taking difficult projects in a variety of challenging materials and seeing them through to a successful conclusion.";
                		$strTitle_2 = "Mould and Tool Makers";
                		$strBlock_2 = "Our in-depth knowledge of Mould and Tool making supported by the latest technologies ensure your design requirements are reflected in the quality of your final product.";
                		$strTitle_3 = "Quality Assurance";
                		$strBlock_3 = "Our technology permits high precision 3D measurement, imaging and comparison of parts and compound structures within production and quality assurance processes.  The devices are used for inspecting components and assemblies, structures in 3D and more.  These same technologies can also be used to undertake reverse engineering.";
						$strTitle_4 = "Supply Chain Integration";
                		$strBlock_4 = "This service enables our engineers to participate and engage in helping our customers deliver success.  This would encompass the coordination of activities and expedition of deliverables.";
                	?>
					<li>
                        <a href="#" data-largesrc="img/portfolio/portfolio-17.png" data-title="<?php echo $strTitle_1; ?>" data-description="<?php echo $strBlock_1; ?>">
                            <img src="img/portfolio/portfolio-17.png" alt="img17"/>
                            <div class="works_title"><span>more info...</span></div>
                            <div class="click_prompt"><span><?php echo $strTitle_1; ?>...</span></div>
                        </a>
	                    <div class="thumbs">
	                        <a href="#" data-largesrc="img/portfolio/portfolio-17.png" data-thumb="img/portfolio/thumbs/portfolio-17-thumb.png" data-title="<?php echo $strTitle_1; ?>" data-description="<?php echo $strBlock_1; ?>"></a>
	                        <a href="#" data-largesrc="img/portfolio/portfolio-9.png" data-thumb="img/portfolio/thumbs/portfolio-9-thumb.png" data-title="<?php echo $strTitle_1; ?>" data-description="<?php echo $strBlock_1; ?>"></a>
	                        <a href="#" data-largesrc="img/portfolio/portfolio-1.png" data-thumb="img/portfolio/thumbs/portfolio-1-thumb.png" data-title="<?php echo $strTitle_1; ?>" data-description="<?php echo $strBlock_1; ?>"></a>
	                        <a href="#" data-largesrc="img/portfolio/portfolio-13.png" data-thumb="img/portfolio/thumbs/portfolio-13-thumb.png" data-title="<?php echo $strTitle_1; ?>" data-description="<?php echo $strBlock_1; ?>"></a>
	                    </div>
                    </li>
                    <li>
                        <a href="#" data-largesrc="img/portfolio/portfolio-14.png" data-title="<?php echo $strTitle_2; ?>" data-description="<?php echo $strBlock_2; ?>">
                            <img src="img/portfolio/portfolio-14.png" alt="img01"/>
                            <div class="works_title"><span>more info...</span></div>
                            <div class="click_prompt"><span><?php echo $strTitle_2; ?>...</span></div>
                        </a>
	                    <div class="thumbs">
					...
					<li>
                        <a href="#" data-largesrc="img/portfolio/portfolio-11.png" data-title="<?php echo $strTitle_3; ?>" data-description="<?php echo $strBlock_3; ?>">
                            ...
                            <div class="works_title"><span>more info...</span></div>
                            <div class="click_prompt"><span><?php echo $strTitle_3; ?>...</span></div>
                        </a>
	                    <div class="thumbs">
					...
					<li>
                        <a href="#" data-largesrc="img/portfolio/portfolio-21.png" data-title="<?php echo $strTitle_4; ?>" data-description="<?php echo $strBlock_4; ?>">
                            ...
                            <div class="works_title"><span>more info...</span></div>
                            <div class="click_prompt"><span><?php echo $strTitle_4; ?>...</span></div>
                        </a>
	                    <div class="thumbs">
	                        <a href="#" data-largesrc="img/portfolio/portfolio-21.png" data-thumb="img/portfolio/thumbs/portfolio-21-thumb.png" data-title="<?php echo $strTitle_4; ?>" data-description="<?php echo $strBlock_4; ?>"></a>
	                        <a href="#" data-largesrc="img/portfolio/portfolio-20.png" data-thumb="img/portfolio/thumbs/portfolio-20-thumb.png" data-title="<?php echo $strTitle_4; ?>" data-description="<?php echo $strBlock_4; ?>"></a>
	                    </div>
                    </li>
                </ul>
            </div><!-- end: #works_items -->
            ...
            <div class="container">            
					...
					<div class="span12 lead">
						...
						<ul>
							...
							<li><span class="strongish">CNC Milling</span><br/>
								...
								3 axis up to 2,000mm x 1,000mm x 1,000mm<br/>
								4 axis up to &empty;400mm x 2,000mm<br/>
							...
							<li><span class="strongish">Surface Grinding</span><br/>
								1 grinder capable of 1,140mm x 580mm</li>
							<li><span class="strongish">Finishing</span><br/>
								1 Jet Washer<br/>
				...
				<div class="row-fluid">
					<div class="span12 lead">
						<strong>Materials Machined</strong>
						<p>Using prismatic machining techniques we are experienced in working with the following materials:</p>
						<ul>
							<li><span class="strongish">Heat Resistant Alloys</span> including;<br/>
								Inconel - 625, 718, 945 & Monel - K500</li>
							<li><span class="strongish">Stainless Steels</span> including;<br/>
								Super Duplex, Duplex, 17-4 & 316L</li>
							<li><span class="strongish">Special Metals</span> including;<br/>
								Molybdenum</li>
							<li><span class="strongish">General Steels</span> including;<br/>
								AISI4130-4145 & P550</li>
							<li><span class="strongish">Toolsteels</span> including;<br/>
								A2, D2, H13, P20 & S7</li>
							<li><span class="strongish">Non Ferrous</span> including;<br/>
								Toughmet, Beryllium Copper, Brass & Aluminium</li>
							<li><span class="strongish">Plastics</span> including;<br/>
								Nylon & Peek</li>
							<li><span class="strongish">Other Materials</span> including;<br/>
								Graphite & Poco Graphite</li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <div class="container txtblock nrthree">
        	<div class="container-inner">
	        	<div class="quote quoteLeft"></div>
	        	<div class="quote quoteRight"></div>
	            <p class="text-center lead">With over 50 years experience we'll handle your order with the utmost professionalism and attention to detail.</p>
			</div>
			...
			<div class="container">
				<div class="row-fluid">
					...
					<div class="span8 lead">
						<p><strong>Fully certified</strong> to <a href="https://www.iso.org/obp/ui/#iso:std:iso:9001:ed-4:v2:en" target="_blank">BS EN ISO 9001:2008</a></p>
        ...
        <div class="container txtblock nrthree">
        	<div class="container-inner">
	        	<div class="quote quoteLeft"></div>
	        	<div class="quote quoteRight"></div>
	            <p class="text-center lead">Our Quality team strives to ensure that your order is managed correctly every step of the way.</p>
			</div>
        </div>

		<section id="about">
            <div class="container">
                <h2 class="text-center">About<i class="icon-about"><img src="img/icon-about-dark.png" alt="about"></i></h2>
                <p class="text-center lead marginer">Founded in 1964, our family run business which celebrated its 50th year in 2014, continues to represent high quality across a variety of market sectors!</p>
                <div class="clear"></div>
	            ...
	            <div class="row-fluid">
	                <div class="span12 lead marginer"><strong>Mould & Toolmaking</strong>. The manufacture of mould tools, jigs and fixtures is second nature to us with over 50 years experience in this industry.</div>
				</div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <div class="person"> 
                            ...
                            <p><a href="tel:01249717832">+44 01249 717832</a></p>
                            <ul class="inline text-center">
                                <a href="https://uk.linkedin.com/in/marc-kenna-75878aba" target="_blank"><i class="ico">I</i></a>
                            </ul>
                        </div>
                    </div>
                    <div class="span3">
...
<!--					<li>
                    ...
                    <li>
                        ...
                        <div class="cbp_tmlabel">
                            <h2>Enhancing our certifications</h2>
                            <p>AJM begin the journey to secure AS9100, OHAS18001, ISO27001, BS11000, ISO14001, ISO 22301 and Nuclear certification.  The team are looking forward to setting new standards in our day to day production processes and achieving our certification at pace!</p>
                        </div>
                    </li>
                    <li>
...
-->
		...
		<script>
           ...
           $('#slider').cycle({
			...
			$('.navbar a.navi, a.scrollto').click(function(e){
